...
## --> Agilent ESG-Series FLEXlm Crypt Generator, agilent-esg.cgi
...
if (!$hostid) {
  $hostid = "9AA2A55F"; # Mine
}

if (!$option) {
  $option = "100"; # ARB Multi-Channel 3GPP and 1.0 W-CDMA
}
...
print "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 3.2//EN\">".
	  ...
	  "<font face=\"Helvetica\">\n".
      "<center>".
      "<h1>Agilent ESG-Series Signal Generator<br>FLEXlm Crypt Generator Results</h1>".
      "</center>".
	  "<blockquote>".
...
open(F, ">", "license.lic") or die "Can't open license.lic: $!\n" ;
  print F "FEATURE $option TMOMID01 1.0 permanent uncounted 0123456789AB VENDOR_STRING=0 HOSTID=$hostid\n";
close F;
